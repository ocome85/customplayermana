...
import java.util.function.Supplier;
    ...
    public enum ModArmorMaterials  implements ArmorMaterial {
        BIRCH("birch", 5, new int[]{1, 1, 2, 1}, 15, SoundEvents.WOOD_PLACE, 0.0F, 0.0F, () -> {
            return Ingredient.of(Items.BIRCH_LOG);
        }),

        BIRCH_PLANK("birch_plank", 5, new int[]{1, 1, 1, 1}, 15, SoundEvents.WOOD_PLACE, 0.0F, 0.0F, () -> {
        ...
        public String getName() {
            return BirchLovelyMod.MOD_ID+":"+ this.name;
        }
